...
// Load env: prefer .env, fallback to .env.local
...
// Resolve network to allowed literals
...
const maxSupply   = BigInt(process.env.NEW_TOKEN_MAX_SUPPLY || '0'); // 0n = unlimited
