...
const Body = z.object({
  ...
  maxSupply: z.string().regex(/^[0-9]+$/), // base units
...
export async function POST(req: Request){
  ...
  try{
    ...
    const maxSupplyBig = BigInt(b.maxSupply); // base units
    // catatan: beberapa SDK hanya mengembalikan txId. Kalau tokenIdentifier ada, kita ikutkan.
