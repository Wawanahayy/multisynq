...
/**
 * ENV (client):
 * - NEXT_PUBLIC_BG_KIND: "image" | "video" (default: image)
 * - NEXT_PUBLIC_BG_URL:  "/bg.jpg" | "https://…"
 * - NEXT_PUBLIC_BG_OPACITY: 0..1 (default 1)     -> opacity media
 * - NEXT_PUBLIC_BG_OVERLAY_OPACITY: 0..1 (default 0) -> overlay gelap (0=off)
 * - NEXT_PUBLIC_BG_FIT: "cover" | "contain" | "fill" (default: cover)
 * - NEXT_PUBLIC_BG_POSITION: CSS object-position, ex: "50% 50%", "center top" (default: "50% 50%")
 * - NEXT_PUBLIC_BG_BLUR: px (default 0)
 * - NEXT_PUBLIC_BG_BRIGHTNESS: 0..2 (default 1)
 */
