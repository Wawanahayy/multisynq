...
(async () => {
  ...
  // 2) START CREATE (versi 2 + snake case)
  const createInput = {
    version: 2,
    create_input: {
  ...
  // 4) Hitung btkn1… (deterministik, tidak perlu nunggu explorer)
  ...
  // 5) Mint 1 unit (10^decimals) ke receiver
